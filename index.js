...
// ── FAQ ──
const FAQS = [
  { q: "Is Tagger.top completely free?",          a: "Yes — 100% free. No account, no credit card, no subscription. Just browse and watch." },
  { q: "Do I need to create an account?",       a: "No registration needed. Find something you like and start watching immediately." },
  { q: "What video quality is available?",      a: "Tagger.top streams in HD where available, depending on the server and your internet speed." },
  ...
  { q: "Does Tagger.top work on mobile?",         a: "Absolutely. Tagger.top is fully optimised for mobile browsers — no app needed." },
];
