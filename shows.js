...
function updateShowTitle() {
  ...
  if (query) document.title = `"${query}" Shows — Tagger.top`;
  else if (genre) document.title = `Free ${genre} Shows Online | Tagger.top`;
  else document.title = "Free TV Shows Online — Browse & Stream HD | Tagger.top";
}
