...
function updateMovieTitle() {
  ...
  if (query) document.title = `"${query}" Movies — Tagger.top`;
  else if (genre) document.title = `Free ${genre} Movies Online | Tagger.top`;
  else document.title = "Free Movies Online — Browse & Stream HD | Tagger.top";
}
